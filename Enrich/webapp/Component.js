sap.ui.define([
    ...
    "sap/ui/Device",
    "com/sap/bpm/Enrich/model/models",
    "sap/ui/model/json/JSONModel"
], function (UIComponent, Device, models, JSONModel) {
    "use strict";

    return UIComponent.extend("com.sap.bpm.Enrich.Component", {
        ...
        //     var contextModel = new JSONModel("/comsapbpmEnrich/bpmworkflowruntime/v1/task-instances/" + taskId + "/context");
        //     this.setModel(contextModel);

        //     var taskInstanceModel = new JSONModel("/comsapbpmEnrich/bpmworkflowruntime/v1/task-instances/" + taskId);
