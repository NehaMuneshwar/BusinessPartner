sap.ui.define([
    ...
    "use strict";
    return Controller.extend("com.sap.bpm.CreateRequest.BaseController", {
        ...
        fnInitializeApp: function () {
            ...
            var sRootPath = jQuery.sap.getModulePath("com.sap.bpm.CreateRequest");
            oBPModel.attachRequestCompleted(function (oEvent) {

                var requestId = Math.floor(Date.now() / 1000);
                oBPModel.setProperty("/RequestId", requestId);
                oBPModel.refresh();
            });
            oBPModel.loadData(sRootPath + "/model/BPMaster.json", null, false);
        },
        /**
